package com.app.swagliv.twiliovoice;
...
//            params.put("name", "Custom value");
    ...
    public static AlertDialog createIncomingCallDialog(
        ...
        String status = callInvite.getCallerInfo().isVerified() == null ? "unverified" : String.valueOf(callInvite.getCallerInfo().isVerified());
        alertDialogBuilder.setMessage(callInvite.getFrom() + " is calling with " + status + " status");
    ...
    private void registerForCallInvites() {
       ...
       /* FirebaseInstanceId.getInstance().getInstanceId().addOnSuccessListener(this, instanceIdResult -> {
            ...
            Log.e("FCM registration","is done here 003"+fcmToken);
