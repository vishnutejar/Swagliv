...
public class ImagePicker {
    ...
    ImagePicker(Builder builder) {
        ...
        context.get().startActivityForResult(callingIntent, imageConfig.requestCode);
    }
            ...
            switch (directory) {
                case DEFAULT:
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                        this.imageConfig.directory = getContext().getExternalCacheDir() + ImageTags.Tags.IMAGE_PICKER_DIR;
                    }
                    break;
                default:
                    break;
