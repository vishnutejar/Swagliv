...
public class ProgressBarLayout extends FrameLayout {
    ...
    public ProgressBarLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        spotsCount = a.getInt(R.styleable.Dialog_DialogCount, DEFAULT_COUNT);
        a.recycle();
    }
