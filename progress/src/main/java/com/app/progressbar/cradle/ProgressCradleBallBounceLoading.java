...
public class ProgressCradleBallBounceLoading extends LinearLayout {

    private ProgressCradleBallBounce cradleBallOne;
    private ProgressCradleBallBounce cradleBallTwo;
    private ProgressCradleBallBounce cradleBallThree;
    private ProgressCradleBallBounce cradleBallFour;
    private ProgressCradleBallBounce cradleBallFive;
    ...
    public ProgressCradleBallBounceLoading(Context context) {
        super(context);
        initView(context);
    }

    public ProgressCradleBallBounceLoading(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }

    public ProgressCradleBallBounceLoading(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initView(context);
    }

    private void initView(Context context) {
        LayoutInflater.from(context).inflate(R.layout.progressbar_cradle_ball_bounce_loading, this, true);
    }

    @Override
    protected void onFinishInflate() {
        super.onFinishInflate();
        cradleBallOne = (ProgressCradleBallBounce) findViewById(R.id.ball_one);
        cradleBallTwo = (ProgressCradleBallBounce) findViewById(R.id.ball_two);
        cradleBallThree = (ProgressCradleBallBounce) findViewById(R.id.ball_three);
        cradleBallFour = (ProgressCradleBallBounce) findViewById(R.id.ball_four);
        cradleBallFive = (ProgressCradleBallBounce) findViewById(R.id.ball_five);
